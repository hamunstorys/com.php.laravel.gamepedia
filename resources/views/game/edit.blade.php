    ...
    <div class="container">
        <div class="row">
            <div class="col-4 text-lg-center">
                <h1><span class="badge badge-info">게임 정보 수정</span></h1>
            </div>
            <div class="col-8">
            ...
            <div class="col-lg-8 push-lg-4 personal-info">
                <form role="form">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <input class="form-control" type="text" placeholder="OS" id="game_minimun_spec1" name="game_minimun_spec1" value="{{old('game_minimun_spec1')}}"/>
                        </div>
                        <div class="col-lg-4">
                            <input class="form-control" type="text" placeholder="CPU" id="game_minimun_spec2" name="game_minimun_spec2" value="{{old('game_minimun_spec2')}}"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label form-control-label"></label>
                        <div class="col-lg-4">
                            <input class="form-control" type="text" placeholder="RAM" id="game_minimun_spec3" name="game_minimun_spec3" value="{{old('game_minimun_spec3')}}"/>
                        </div>
                        <div class="col-lg-4">
                            <input class="form-control" type="text" placeholder="VGA" id="game_minimun_spec4" name="game_minimun_spec4" value="{{old('game_minimun_spec4')}}"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label form-control-label">권장 사양</label>
                        <div class="col-lg-4">
                            <input class="form-control" type="text" placeholder="OS" id="game_recommend_spec1" name="game_recommend_spec1" value="{{old('game_recommend_spec1')}}"/>
                        </div>
                        <div class="col-lg-4">
                            <input class="form-control" type="text" placeholder="CPU" id="game_recommend_spec2" name="game_recommend_spec2" value="{{old('game_recommend_spec2')}}"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label form-control-label"></label>
                        <div class="col-lg-4">
                            <input class="form-control" type="text" placeholder="RAM" id="game_recommend_spec3" name="game_recommend_spec3" value="{{old('game_recommend_spec3')}}"/>
                        </div>
                        <div class="col-lg-4">
                            <input class="form-control" type="text" placeholder="VGA" id="game_recommend_spec4" name="game_recommend_spec4" value="{{old('game_recommend_spec4')}}"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <a href="javascript:window.history.back()"><input type="button" class="btn btn-outline-secondary"
                                                                              value="취소"/></a>
                        </div>
                    </div>
                </form>
